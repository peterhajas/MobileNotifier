...
MobileNotifier_FILES = Tweak.xm MNAlertData.m MNAlertManager.m MNAlertViewController.m MNAlertDashboardViewController.m MNAlertWindow.m MNWhistleBlowerController.m MNTableViewCell.m
